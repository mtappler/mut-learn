...
public class EvaluateServer {
	...
	static <T extends TestCase> List<RandomCovSelEquivConfiguration<T>> configs(MultipleModeConfig config){
		...
		mutSplit1OutGenMuDirectedConfig.mutantSampler = new CompositionSampler(
				...
				new ElementBasedBoundSampler(30000, new Random(),"operator:split-state-1")
	...
	private static int upperNrTests = 80000;
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul("src/main/resources/tcp/tcp_server_bsd_trans.dot");
		...
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "rv_experiments", "tcp.bsd.server");
		evaluator.setUseRV();
