...
public class EvaluateClient {
	...
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul("src/main/resources/tcp/tcp_client_windows_trans.dot");
		...
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "experiments", "tcp.windows.client");
