 ...
 *******************************************************************************/
package at.tugraz.mutation_equiv.eval.experiments.mqtt.mosquitto;
...
public class EvaluateMosquittoSingleClient {
	...
	public static void main(String[] args){
		SULWithAlphabet<Symbol, String> sul = new MealyDotFileSul("src/main/resources/mqtt/mosquitto/single_client.dot");
		MultipleModeConfig config = new MultipleModeConfig(40, 8000, sul);
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "experiments", "mqtt.mosquitto.single_client");
		evaluator.performMultMeasurementSeries(50, 2000, 50, 10, configs(config));
	}
