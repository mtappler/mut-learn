...
public class EvaluateClient {
	...
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul("src/main/resources/tcp/tpc_client_ubuntu_trans.dot");
		...
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "experiments", "tcp.ubuntu.client");
