...
public class EvaluateEmqttTwoClientWillRetain {
	...
	public static void main(String[] args){
		SULWithAlphabet<Symbol, String> sul = new MealyDotFileSul(
				"src/main/resources/mqtt/emqtt/two_client_will_retain.dot");
		MultipleModeConfig config = new MultipleModeConfig(40, 10000, sul,
				new MuDirectedIterativeGenerator(0.05, 0.95, sul.getAlphabet(), 40, 6));

		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "rv_experiments", "mqtt.emqtt.two_client_will_retain");
		evaluator.setUseRV();
		evaluator.performMultMeasurementSeries(25, upperNrTests, 25, 18, configs(config));
	}
