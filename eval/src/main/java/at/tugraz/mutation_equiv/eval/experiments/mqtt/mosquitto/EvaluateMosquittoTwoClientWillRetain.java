...
public class EvaluateMosquittoTwoClientWillRetain {
...
//		
	...
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul(
				"src/main/resources/mqtt/mosquitto/two_client_will_retain.dot");
		...
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "rv_experiments", "mqtt.mosquitto.two_client_will_retain");
		evaluator.setUseRV();
