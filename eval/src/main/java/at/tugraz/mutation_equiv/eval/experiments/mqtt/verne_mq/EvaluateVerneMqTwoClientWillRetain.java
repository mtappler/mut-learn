...
public class EvaluateVerneMqTwoClientWillRetain {
...
//		ly.nameSuffix = "_ly";
	...
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul(
				"src/main/resources/mqtt/VerneMQ/two_client_will_retain.dot");
		...
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "rv_experiments", "mqtt.verne_mq.two_client_will_retain");
		evaluator.setUseRV();
