...
//		
	...
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul("src/main/resources/mqtt/ActiveMQ/single_client.dot");
		MultipleModeConfig config = new MultipleModeConfig(40, 8000, sul);
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "experiments", "mqtt.active_mq.single_client");
