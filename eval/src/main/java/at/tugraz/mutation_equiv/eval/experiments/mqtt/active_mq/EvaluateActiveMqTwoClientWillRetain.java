 ...
 *******************************************************************************/
package at.tugraz.mutation_equiv.eval.experiments.mqtt.active_mq;
...
public class EvaluateActiveMqTwoClientWillRetain {
...
//		ly.nameSuffix = "_ly";
	...
	public static void main(String[] args){
		MealyDotFileSul sul = new MealyDotFileSul(
				"src/main/resources/mqtt/ActiveMQ/two_client_will_retain.dot");
		...
		Evaluator evaluator = 
				new Evaluator(RandomSeedSample.seeds,sul, "rv_experiments", "mqtt.active_mq.two_client_will_retain");
		evaluator.setUseRV();
